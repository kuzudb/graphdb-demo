...
if __name__ == "__main__":
    graph_rag = GraphRAG("./ex_kuzu_db")
    question = "In the movie Interstellar, who played Murphy Cooper? How old is the actor who played her?"
    response = graph_rag.run(question)
    print(f"Q1: {question}\n\n{response}\n---\n")

    question = "Who was Murphy Cooper's father in the movie Interstellar? What did he do?"
    response = graph_rag.run(question)
    print(f"Q2: {question}\n\n{response}\n---\n")

    question = "Can you tell me about Tom Cooper, Murphy's brother, from the movie Interstellar?"
    response = graph_rag.run(question)
    print(f"Q3: {question}\n\n{response}\n---\n")
